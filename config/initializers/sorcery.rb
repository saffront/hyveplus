...
Rails.application.config.sorcery.submodules = [:reset_password, :external, :session_timeout]
...
Rails.application.config.sorcery.configure do |config|
  ...
  if Rails.env.staging? || Rails.env.development?
    ...
    config.facebook.callback_url = "http://hyve-production.herokuapp.com/oauth/callback?provider=facebook"
    config.google.callback_url = "http://hyve-production.herokuapp.com/oauth/callback?provider=google"
  end
